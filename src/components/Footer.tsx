...
const Footer = () => {
  return (
    <footer className="w-full bg-black text-white py-4">
      <div className="flex justify-between items-center w-[1100px] mx-auto">
        <div className="text-sm text-gray-400">
          Hemsida tillverkad av <Link href="https://joox.se" className="text-white hover:underline" target="_blank">Studio Joox AB</Link>
        </div>
